...
namespace IPC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Recieve(RedBoxLayoutViewModel model)
        {
            ...
            else if (commandSplit[0].ToLower() == "sh" && userType == "MA")
            {
                RedBoxLayoutViewModel rbmodel = new RedBoxLayoutViewModel();
                if (commandSplit[1] == "" || commandSplit[1] == null)
                {
            ...
            //search Allergies
            else if (commandSplit[0].ToLower() == "all" && userType == "MA")
            {
                RedBoxLayoutViewModel rbmodel = new RedBoxLayoutViewModel();
                if (commandSplit[1] == "" || commandSplit[1] == null)
                {
                ...
                else
                {
                    ...
                    List<Allergies> check = new List<Allergies>()
                    {
                        new Allergies {Value= 1,Text=}
                    };
